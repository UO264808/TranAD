...
class SkipGramNS(nn.Module):
    def __init__(self, feats) -> None:
        ...
        self.w = None#nn.Embedding(self.vocab_size, self.embed_size, sparse=True)
        # Context embeddings
        self.c = None#nn.Embedding(self.vocab_size, self.embed_size, sparse=True)
        # Linear output layer
